...
public class CopyOfApitest8 {
    ...
    public void test() throws SQLException, RecognitionException, ParseException, IOException {
    	...
    	QueryExecutor ex = new QueryExecutor("select \\ALL*[emailmessage]\\ FROM \\ALL/emailmessage\\ WHERE ( \\ALL*folder\\ = 'sent_items' OR \\ALL*folder\\= 'sent') AND ( \\ALL*email_address*_:sender\\='susan.scott@enron.com' )", 100);
    	ex.enableDebug(true);
