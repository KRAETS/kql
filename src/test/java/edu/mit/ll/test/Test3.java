...
public class Test3 {
    ...
    public void test() throws JsonSyntaxException, CannotProceedException {
    	String query = "SELECT \\ALL/DimensionSet1*Dimension1\\";
        ...
        for(int i=0; i<aexpqueries.size()-1;i++){
            try {
                ...
                Assert.assertEquals("{resultTables:null resultFields:[Field1]}", processor.process(aexpqueries.get(i),true).toString());
