...
public class NadsAPITest5 {
    ...
    public void test() throws SQLException, RecognitionException, ParseException, IOException, CannotProceedException {
    	QueryExecutor ex = new QueryExecutor("SELECT \\ ALL*{protocol} \\ from \\ ALL/{protocol,portnumber,status,id,ip_address} \\ where (  \\ ALL*protocol*_:host \\ like \"*\"  ) and ( \\ ALL*status \\ like \"*Accepted*\" )", 100);
