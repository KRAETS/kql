...
public class Test33 {
    ...
    static Logger log = Logger.getLogger(Test33.class);
    ...
    public void test() throws JsonSyntaxException, CannotProceedException {
        ...
        for(int i=0; i<aexpqueries.size()-1;i++){
            try {
                ...
                Assert.assertEquals("{resultTables:null resultFields:[Field3]}", processor.process(aexpqueries.get(i),true).toString());
