...
public class DbTest2 {
    ...
    static Logger log = Logger.getLogger(DbTest2.class);
    ...
    @Test
    public void test() throws JsonSyntaxException, CannotProceedException, SQLException {
    	Connection con = DriverManager.getConnection("jdbc:mongo://localhost:27017/enron_mail_clean",
                "myUserAdmin", "abc123");
    	con.createStatement().getFetchSize();
