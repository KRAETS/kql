...
public class Test8 {
    ...
    static String testName = "Test8";    
    static Logger log = Logger.getLogger(Test8.class);
    ...
    @Test
    public void test() {
    	String query = "SELECT \\ALL/DimensionSet2*Dimension3*TagScheme2:Tag2\\";
    	Parser p = new Parser();
        ...
        for(int i=0; i<aexpqueries.size()-1;i++){
            try {
                ...
                Assert.assertEquals("{resultTables:null resultFields:[Field5]}", r1);
